...
const ServerError: React.FC = () => {
  return (
    <div className="w-full lg:h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        <p className="text-2xl md:text-5xl lg:text-9xl font-bold tracking-wider text-gray-300">
          500
        </p>
        <p className="text-xl md:text-4xl lg:text-6xl font-bold tracking-wider text-gray-300 mt-2">
          Server Error
        </p>
        <p className="text-sm md:text-xl lg:text-2xl text-gray-500 my-6 lg:my-12">
          Whoops, something went wrong on our servers.
        </p>
      </div>
      <div className="w-1/2 md:h-[300px] lg:h-full flex lg:items-end justify-center p-4">
        <svg
